...
def get_ark_pretrain_params():
    ...
    # data/config
    parser.add_argument('--datasets_yaml', type=str, required=True, help='YAML listing datasets with paths/splits/num_classes')
    parser.add_argument('--save_dir', type=str, default='./outputs/ark_pretrain', help='Checkpoint directory')
    parser.add_argument('--num_workers', type=int, default=8)
    parser.add_argument('--batch_size', type=int, default=1, help='Batches are slides; 1 is typical')
